...
import net.jojoaddison.xmserv.security.ResourcesConstant;
import net.jojoaddison.xmserv.service.dto.AuthorityDTO;
import net.jojoaddison.xmserv.service.mapper.AuthorityMapper;
...
public class RoleResource {
    ...
    public RoleResource(AuthorityRepository authorityRepository, AuthorityMapper authorityMapper){
    ...
    @Timed
    @PreAuthorize("@securityValidator.hasPermission('ROLE_RESOURCE', 'CREATE')")
    ...
    @RequestMapping(value = "/roles",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    @PreAuthorize("@securityValidator.hasPermission('ROLE_RESOURCE', 'EDIT')")
    ...
    @PreAuthorize("@securityValidator.hasPermission('ROLE_RESOURCE', 'VIEW')")
    ...
    @RequestMapping(value = "/roles/{name}",
        ...
        produces = MediaType.APPLICATION_JSON_VALUE)
    @Timed
    @PreAuthorize("@securityValidator.hasPermission('ROLE_RESOURCE', 'DELETE')")
