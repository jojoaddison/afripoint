...
class OrderGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Order entity")
        ...
        .repeat(2) {
            ...
            .post("/api/orders")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "orderItems":"SAMPLE_TEXT", "totalAmount":null, "customer":"SAMPLE_TEXT", "shop":"SAMPLE_TEXT", "deliveryAddress":"SAMPLE_TEXT", "createdDate":"2020-01-01T00:00:00.000Z", "modifiedDate":"2020-01-01T00:00:00.000Z", "lastModifiedBy":"SAMPLE_TEXT", "notes":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
