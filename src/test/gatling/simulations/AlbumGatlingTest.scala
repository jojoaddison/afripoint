...
class AlbumGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Album entity")
        ...
        .repeat(2) {
            ...
            .post("/api/albums")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "description":"SAMPLE_TEXT", "createdBy":"SAMPLE_TEXT", "modifiedBy":"SAMPLE_TEXT", "createdDate":"2020-01-01T00:00:00.000Z", "modifiedDate":"2020-01-01T00:00:00.000Z", "media":"SAMPLE_TEXT", "photo":null}""")).asJSON
            .check(status.is(201))
