...
class ShopGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Shop entity")
        ...
        .repeat(2) {
            ...
            .post("/api/shops")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "owner":"SAMPLE_TEXT", "products":"SAMPLE_TEXT", "physicalAddress":"SAMPLE_TEXT", "virtualAddress":"SAMPLE_TEXT", "createdDate":"2020-01-01T00:00:00.000Z", "modifiedDate":"2020-01-01T00:00:00.000Z", "category":null}""")).asJSON
            .check(status.is(201))
