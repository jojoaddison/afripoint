...
class ArticleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Article entity")
        ...
        .repeat(2) {
            ...
            .post("/api/articles")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "aid":"SAMPLE_TEXT", "pages":null, "createdDate":"2020-01-01T00:00:00.000Z", "modifiedDate":"2020-01-01T00:00:00.000Z", "createdBy":"SAMPLE_TEXT", "modifiedBy":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
